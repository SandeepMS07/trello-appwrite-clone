...
function Board() {
  ...
  const handleOnDragEnd = (result: DropResult) => {
    ...
    console.log(startColIndex, "start col index");
    console.log(finishColIndex, "finish col index");
    ...
    console.log(finishCol, "finish col");
    ...
    console.log(newTodos, "newTODOS", todoMoved, "todomoved");
